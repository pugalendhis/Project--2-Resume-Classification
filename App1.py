...
def extract_skills(resume_text):
    ...
    data = pd.read_csv(r"C:\Users\ROHIT\Desktop\Internship Project\P266\skills.csv") # reading the csv file
...
# MAIN CODE
import pickle as pk
model = pk.load(open(r'C:\Users\ROHIT\Desktop\Internship Project\P266\ModelRFC.pkl', 'rb'))
Vectorizer = pk.load(open(r'C:\Users\ROHIT\Desktop\Internship Project\P266\VECTOR2.pkl', 'rb'))
